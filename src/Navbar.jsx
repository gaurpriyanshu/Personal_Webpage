...
function Navbar() {
  ...
  return (
    <nav id="navbar">
      ...
      <a href="https://www.linkedin.com/in/gaurpriyanshu/" target="_blank" className="icons">
        <FontAwesomeIcon icon={faLinkedin} size="2x" />
      </a>
      <a href="https://github.com/gaurpriyanshu" target="_blank" className="icons">
      ...
      <div className="Introduction">
        ...
        <p>
          I'm a graduate from IIIT Bhopal seeking many ways to improve my
